    ...
    private fun observeListener() {
        ...
        shopViewModel.shopListLiveData.observe(viewLifecycleOwner, { shopList ->
            when (shopList) {
                ...
                is Resource.Loading ->shopAdapter.addMainShopListItems(shopList.data)
        ...
        shopViewModel.offersListLiveData.observe(viewLifecycleOwner, { offersList ->
            when (offersList) {
                ...
                is Resource.Loading ->shopAdapter.addOffersListItems(offersList.data)
        ...
        shopViewModel.categoryLiveData.observe(viewLifecycleOwner, { category ->
            when (category) {
                ...
                is Resource.Loading ->navigateToAllProductsFragment(category.data!!)
                is Resource.Error -> {
                    navigateToAllProductsFragment(category.data!!)
                }
            }
